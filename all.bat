...
#    echo %%i
#    echo SIM
#    java -jar icvolti_tfidf.jar -d ..\bcb_reduced\%%i -l java -oc result20190807sim09\%%i.csv
    
#)

java -jar icvolti.jar -d src -l java -oc srcicvolti.csv
...
#java -jar icvolti_tfidf.jar -d ..\bcb_reduced\40 -l java -oc result20190807sim09\40.csv
pause
